...
- (void)getDisplayMedia:(NSDictionary*)constraints result:(FlutterResult)result {
  ...
  */
  ...
  if (useDefaultScreen) {
    ...
    sourceType = source.sourceType == RTCDesktopSourceTypeWindow ? @"window" : @"screen";
    if (source.sourceType == RTCDesktopSourceTypeScreen || source.sourceType == RTCDesktopSourceTypeWindow) {
      useScreenCaptureKit = YES;
    } else {
                                         ...
                                         sourceType:sourceType
                                          onStarted:^(NSError * _Nullable error) {
                                            if (error != nil) {
                                              ...
                                              NSLog(@"start screencapturekit capture: sourceId: %@, sourceType: %@, fps: %lu",
                                                    sourceId, sourceType, fps);
                                            }
                                          }];
    } else {
