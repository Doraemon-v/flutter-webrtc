...
@property(nonatomic, strong)
    NSMutableDictionary<NSString*, MLVirtualBackgroundProcessor*>* _Nullable virtualBackgroundProcessors;
...
- (void)detachVirtualBackgroundProcessorForTrackId:(NSString* _Nonnull)trackId;
